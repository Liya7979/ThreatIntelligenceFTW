...
public class JSONToCVE {
    ...
    private void parseCVE(JSONObject arrayElem) throws JSONException {
        ...
        cve.setDescription(jsonCVE.getJSONObject("description").getJSONArray("description_data").getJSONObject(0).getString("value"));
        cve.setRefs(parseReferences(jsonCVE.getJSONObject("references").getJSONArray("reference_data")));
    ...
    private Vendor parseVendor(JSONObject jsonVendor) throws JSONException {
    ...
    private MetricsV3 parseMetricsV3(JSONObject jsonImpact) throws JSONException {
    ...
    private MetricsV2 parseMetricsV2(JSONObject jsonImpact) throws JSONException {
